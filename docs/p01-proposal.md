...
| [NBA Data Summarized](https://github.com/MattC137/Open_Data/blob/master/Data/Sports/NBA/NBA_2016_Players.csv) | This [NBA 2016 Players](/data/NBA_2016_Stats.csv) dataset is compiled by MattCC13 that was imported from the official NBA website. | There are 400 rows which indicate observations for 400 players in the NBA | There are 18 columns or features.
